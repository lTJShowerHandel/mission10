Prompt: 
I’m building an app with a .NET 10 / C# back end and a React / typescript front end. 
Can you set up the templates for me? We want to make sure that prettier is included 
as the code formatter. We want to have the React portion in a folder called “frontend”, 
and we want to have the .NET portion in a folder named “backend” 
...
(This has been downloaded and is in the project directory)
